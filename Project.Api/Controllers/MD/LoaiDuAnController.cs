...
namespace Project.Api.Controllers.MD
{
    ...
    [ApiController]
    public class LoaiDuAnController(ILoaiDuAnService service) : ControllerBase
    {
        public readonly ILoaiDuAnService _service = service;

        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] LoaiDuAnDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] LoaiDuAnDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] LoaiDuAnDto request)
        {
            var res = new TransferObject();

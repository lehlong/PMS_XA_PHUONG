...
namespace Project.Api.Controllers.MD
{
    ...
    [ApiController]
    public class ProjectRoleController(IProjectRoleService service) : ControllerBase
    {
        public readonly IProjectRoleService _service = service;

        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] ProjectRoleDto filter)
        {
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] ProjectRoleDto request)
        {
            var res = new TransferObject();

...
namespace Project.Api.Controllers.MD
{
    ...
    [ApiController]
    public class CapDuAnController(ICapDuAnService service) : ControllerBase
    {
        public readonly ICapDuAnService _service = service;

        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] CapDuAnDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] CapDuAnDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] CapDuAnDto request)
        {
            var res = new TransferObject();

...
namespace Project.Api.Controllers.MD
{
    ...
    public class AreaController(IAreaService service) : ControllerBase
    {
        ...
        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] AreaDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] AreaDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] AreaDto request)
        {
            var res = new TransferObject();

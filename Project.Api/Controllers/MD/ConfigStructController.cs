...
namespace Project.Api.Controllers.MD
{
    ...
    [ApiController]
    public class ConfigStructController(IConfigStructService service) : ControllerBase
    {
        public readonly IConfigStructService _service = service;

        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] ConfigStructDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] ConfigStructDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] ConfigStructDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("UpdateOrder")]
        public async Task<IActionResult> UpdateOrder([FromBody] List<ConfigStructDto> request)
        {
            var res = new TransferObject();

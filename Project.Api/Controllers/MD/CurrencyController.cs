...
namespace Project.Api.Controllers.MD
{
    ...
    public class CurrencyController(ICurrencyService service) : ControllerBase
    {
        ...
        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] CurrencyDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] CurrencyDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] CurrencyDto request)
        {
            var res = new TransferObject();

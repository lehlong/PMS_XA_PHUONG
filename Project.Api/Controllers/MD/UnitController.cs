...
namespace Project.Api.Controllers.MD
{
    ...
    public class UnitController(IUnitService service) : ControllerBase
    {
        ...
        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] UnitDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] UnitDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] UnitDto request)
        {
            var res = new TransferObject();
